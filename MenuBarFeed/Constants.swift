...
//  MenuBarFeed
//
//  Created by Fred Murakawa on 05/10/22.
//
...
struct Constants {
    ...
    static let twitterUsersKey = "twitterUsers"
    static let subredditsNamesKey = "subredditsNamesKey"
    static let isHackerNewsSelectedKey = "isHackerNewsSelected"
    static let isRedditSelectedKey = "isRedditSelected"
    static let menuBarMaxCharactersKey = "menuBarMaxCharacters"
    static let feedRefreshIntervalKey = "feedRefreshInterval"
}
